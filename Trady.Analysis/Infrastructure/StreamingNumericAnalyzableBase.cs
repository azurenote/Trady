...
{
    public abstract class StreamingNumericAnalyzableBase<TInput, TMappedInput, TOutput>
        : StreamingAnalyzableBase<TInput, TMappedInput, decimal?, TOutput>, IDiffAnalyzable<TOutput>, ISmaAnalyzable<TOutput>, IRDiffAnalyzable<TOutput>, ISdAnalyzable<TOutput>
    {
        protected StreamingNumericAnalyzableBase(IList<TInput> inputs, Func<TInput, TMappedInput> inputMapper)
